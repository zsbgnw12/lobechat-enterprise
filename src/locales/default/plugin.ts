export default {
  ...
  'builtins.lobe-skill-store.apiName.importFromMarket': 'Import from catalog',
  ...
  'empty.description': 'Browse the skill catalog. Install one to get started, add more later.',
  ...
  'protocolInstall.official.badge': '超级运营中心 Official Skill',
  'protocolInstall.official.description':
    'Official 超级运营中心 Skill, verified and security-checked.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. 超级运营中心 does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
  'skillInstallBanner.dismiss': 'Dismiss',
  'skillInstallBanner.title': 'Add skills to 超级运营中心',
  ...
  'store.networkError': 'Failed to fetch the skill catalog. Check network and retry.',
