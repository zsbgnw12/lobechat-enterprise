export default {
  ...
  'memory.enabled.desc':
    'Allow 超级运营中心 to extract preferences and info from conversations and use them later. You can view, edit, or clear memory anytime.',
  ...
  'plugin.empty': 'No Skills installed yet. Explore the <1>Skill catalog</1> to get started.',
  ...
  'settingSystemTools.tools.lobehub.desc':
    '超级运营中心 CLI - manage and connect to 超级运营中心 services',
  ...
  'skillStore.skillHub.empty': 'No skills in SkillHub yet.',
  'skillStore.skillHub.installed': 'Installed',
  'skillStore.tabs.community': 'Community',
  'skillStore.tabs.custom': 'Custom',
  'skillStore.tabs.lobehub': '超级运营中心',
  'skillStore.tabs.mcp': 'MCP',
  'skillStore.tabs.org': 'Organization',
  'skillStore.tabs.skillHub': 'SkillHub',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'tools.builtins.lobe-skill-store.description':
    'Browse and install agent skills from the organization catalog. Use this when you need extended capabilities or want to install a specific skill.',
  'tools.builtins.lobe-skill-store.title': 'Skill catalog',
  ...
  'tools.builtins.lobehub.description':
    'Manage the 超级运营中心 platform via CLI — knowledge bases, memory, agents, files, search, generation, and more.',
  'tools.builtins.lobehub.title': '超级运营中心',
