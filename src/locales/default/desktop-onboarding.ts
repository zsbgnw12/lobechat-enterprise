export default {
  ...
  'authResult.success.desc':
    'Please click the Start button below to continue using 超级运营中心 Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve 超级运营中心. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve 超级运营中心',
  ...
  'screen5.actions.signInCloud': 'Sign in to 超级运营中心 Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your 超级运营中心 Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': '超级运营中心 Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own 超级运营中心 server instance',
