export default {
  ...
  'assistants.status.support':
    'For any questions, please copy the link and send it to <email>support@example.com</email> for assistance.',
  'assistants.status.unpublished.subtitle':
    'This Agent is under review. To confirm its status, copy the link and email <email>support@example.com</email>.',
  ...
  'createGuide.func1.title': 'Submit in 超级运营中心',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the 超级运营中心 Community.',
  'footer.title': 'Share your creation on 超级运营中心 Community today',
  ...
  'models.providerInfo.apiTooltip':
    '超级运营中心 supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': '超级运营中心 Official Service',
  ...
  'skills.details.sidebar.platform.layout.lobehub':
    'Skills are managed by 超级运营中心 automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the 超级运营中心 marketplace with one click.',
