...
| ---------------- | ------- | ----- | ----------------------------------------- |
| page             | int     | 1     | 页码                                      |
| page\_size       | int     | 50    | 每页，最大 500                            |
| industry         | string  | -     | 精确匹配                                  |
| region           | string  | -     | 精确匹配                                  |
| customer\_status | string  | -     | active / inactive / frozen / prospect     |
| sales\_user\_id  | int     | -     | 所属销售 id                               |
| only\_unassigned | bool    | false | true → 只返回未分配给任何销售的客户       |
| updated\_since   | ISO8601 | -     | 仅返回 updated\_at ≥ since (用于增量同步) |
...
| ------------------ | ------- | ----- | ----------------------------------------------- |
| page               | int     | 1     |                                                 |
| page\_size         | int     | 50    | 最大 500                                        |
| include\_cancelled | bool    | false | true 时包含 allocation\_status=CANCELLED 的记录 |
| customer\_id       | int     | -     | 按客户过滤                                      |
| updated\_since     | ISO8601 | -     | 增量同步                                        |
...
| ---- | -------------------------------------------------------- |
| 200  | OK                                                       |
| 400  | 参数错误 (格式不对，updated\_since 不是合法 ISO8601, 等) |
| 401  | X-Api-Key 缺失或错误                                     |
