          ...
          sessions: [
            {
              ...
              meta: {
                avatar: '📝',
                description:
                  'heichat is an AI conversation application built with the Next.js framework. I will help you write the development documentation for heichat.',
                tags: [
                ...
                title: 'heichat Technical Documentation Expert',
              },
              type: 'agent',
